...
#
# python3.10 -m pip install --upgrade --force-reinstall reportlab
###############################################################################
{
    ...
    'depends': ['base', 'survey', 'website','portal','bt_ajax_upload_file_common','customer_product_qrcode','contacts'],
    'data': [
    ...
    'assets': {
        ...
        'survey.survey_assets': [
            ...
            'enhanced_survey_management/static/src/js/survey_form_file.js',
            'enhanced_survey_management/static/src/js/survey_print.js',
        
        ],
    },
    'external_dependencies': {
        'python' : ['rlPyCairo','reportlab'],
    },
    'license': 'OPL-1',
    'installable': True,
    'auto_install': False,
